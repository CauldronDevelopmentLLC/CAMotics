...
bool Parser::parseOne(CAMotics::Tokenizer &tokenizer, Processor &processor) {
...
SmartPointer<Block> Parser::block(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Comment> Parser::comment(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
...
SmartPointer<Word> Parser::word(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
...
SmartPointer<Assign> Parser::assign(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
...
SmartPointer<OCode> Parser::ocode(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
...
SmartPointer<Entity> Parser::numberRefOrExpr(CAMotics::Tokenizer &tokenizer) {
  switch (tokenizer.getType()) {
...
SmartPointer<Entity> Parser::expression(CAMotics::Tokenizer &tokenizer) {
  return boolOp(tokenizer);
}


SmartPointer<Entity> Parser::boolOp(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Entity> Parser::compareOp(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Entity> Parser::addOp(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Entity> Parser::mulOp(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Entity> Parser::expOp(CAMotics::Tokenizer &tokenizer) {
...
SmartPointer<Entity> Parser::unaryOp(CAMotics::Tokenizer &tokenizer) {
  Operator op;
  switch(tokenizer.getType()) {
  case TokenType::ADD_TOKEN: op = Operator::ADD_OP; break;
  case TokenType::SUB_TOKEN: op = Operator::SUB_OP; break;
...
SmartPointer<Entity> Parser::primary(CAMotics::Tokenizer &tokenizer) {
  switch (tokenizer.getType()) {
...
SmartPointer<Entity> Parser::quotedExpr(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
...
Parser::functionCall(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
  string name = tokenizer.match(TokenType::ID_TOKEN).getValue();
...
SmartPointer<Number> Parser::number(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
  double value =
...
SmartPointer<Entity> Parser::reference(CAMotics::Tokenizer &tokenizer) {
  ParseScope scope(tokenizer.getScanner());
